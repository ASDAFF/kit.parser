...
?>
    ...
    <tr>
        ...
        <td width="60%">
        <?=SelectBoxFromArray('SETTINGS[rss][uniq]', $arrUniq, $kit_SETTINGS["rss"]["uniq"]);?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[rss][sleep]" value="<?=$kit_SETTINGS["rss"]["sleep"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
