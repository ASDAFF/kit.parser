...
?>
    ...
    <tr>
        ...
        <td>
            <?=SelectBoxFromArray('IBLOCK_ID', $arIBlock, $kit_IBLOCK_ID, GetMessage("parser_iblock_id"), "id='iblock' style='width:262px' ");?>
        </td>
    </tr>
    <tr>
        <td></td>
                ...
                if(isset($kit_RSS)) {
                    ...
                    foreach($worksheets as $key=>$wsh){
                        ...
                        echo '<div style="overflow: auto;">
                                ...
                                $utils->printHtmlTable($wsh['lines'],true, $param, $kit_IBLOCK_ID, $key, true);
                        echo "</div>";
                    }
                } else { ?>
                    <?=BeginNote();?>
...
?>
   ...
   <tr>
    ...
    <tr>
        ...
        <td width="60%">
            <?=SelectBoxFromArray('SETTINGS[xls_catalo][auth][type]', $arAuthType, $kit_SETTINGS["xls_catalo"]["auth"]["type"], "", "class='select_load'");?>
        </td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_active")?></td>
        <td width="60%"><input type="checkbox" name="SETTINGS[xls_catalo][auth][active]" value="Y"<?if($kit_SETTINGS["xls_catalo"]["auth"]["active"] == "Y") echo " checked"?>></td>
    </tr>
    <?if((isset($kit_SETTINGS["xls_catalo"]["auth"]["type"]) && $kit_SETTINGS["xls_catalo"]["auth"]["type"]=="form") || !isset($kit_SETTINGS["xls_catalo"]["auth"]["type"])):?>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_url")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][url]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["url"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][selector]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["selector"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_login")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][login]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["login"]?>"> <?echo GetMessage("parser_auth_login_name")?> <input type="text" size="20" name="SETTINGS[xls_catalo][auth][login_name]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["login_name"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_password")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][password]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["password"]?>"> <?echo GetMessage("parser_auth_password_name")?> <input type="text" size="20" name="SETTINGS[xls_catalo][auth][password_name]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["password_name"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_login")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][login]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["login"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_password")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][password]" value="<?=$kit_SETTINGS["xls_catalo"]["auth"]["password"]?>"></td>
    </tr>
    <?endif;?>
    <?if($kit_SETTINGS["xls_catalo"]["auth"]["type"]=="form"):?>
    <tr>
        <td width="40%"></td>
