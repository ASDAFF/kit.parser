...
?>
    ...
    <tr>
        ...
        <td><input type="text" name="RSS" value="<?echo $kit_RSS;?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td><span class="required">*</span><?echo GetMessage("parser_iblock_id")?></td>
        <td><?=SelectBoxFromArray('IBLOCK_ID', $arIBlock, $kit_IBLOCK_ID, GetMessage("parser_iblock_id"), "id='iblock' style='width:262px'");?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="SELECTOR" value="<?echo $kit_SELECTOR;?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td><?echo GetMessage("parser_selector_page")?></td>
        <td><input type="text" name="SETTINGS[page][selector]" value="<?echo $kit_SETTINGS["page"]["selector"];?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td><input type="text" name="SETTINGS[page][href]" value="<?echo $kit_SETTINGS["page"]["href"];?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td><input type="text" name="SETTINGS[page][name]" value="<?echo $kit_SETTINGS["page"]["name"];?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td><input type="text" name="FIRST_URL" value="<?echo $kit_FIRST_URL;?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
        <td>
...
?>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" name="PREVIEW_FIRST_IMG" value="Y"<?if($kit_PREVIEW_FIRST_IMG == "Y") echo " checked"?>></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" name="PREVIEW_SAVE_IMG" value="Y"<?if($kit_PREVIEW_SAVE_IMG == "Y") echo " checked"?>></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input size="80" maxlength="300" type="text" name="PREVIEW_DELETE_ELEMENT" value="<?=$kit_PREVIEW_DELETE_ELEMENT?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input size="80" maxlength="300" type="text" name="PREVIEW_DELETE_ATTRIBUTE" value="<?=$kit_PREVIEW_DELETE_ATTRIBUTE?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
...
?>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" name="DETAIL_FIRST_IMG" value="Y"<?if($kit_DETAIL_FIRST_IMG == "Y") echo " checked"?>></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" name="DETAIL_SAVE_IMG" value="Y"<?if($kit_DETAIL_SAVE_IMG == "Y") echo " checked"?>></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input size="80" maxlength="300" type="text" name="DETAIL_DELETE_ELEMENT" value="<?=$kit_DETAIL_DELETE_ELEMENT?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input size="80" maxlength="300" type="text" name="DETAIL_DELETE_ATTRIBUTE" value="<?=$kit_DETAIL_DELETE_ATTRIBUTE?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
...
?>
    ...
    <tr>
        ...
        <td width="60%">
        <?=SelectBoxFromArray('SETTINGS[page][uniq]', $arrUniq, $kit_SETTINGS["page"]["uniq"]);?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[page][sleep]" value="<?=$kit_SETTINGS["page"]["sleep"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
